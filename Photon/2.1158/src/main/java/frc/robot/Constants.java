...
public class Constants {
    ...
    public static final class PhotonConsts {
        ...
        public static final List<Integer> VALID_REEF_IDS = List.of(1,2,3);//idk yet

        public static final double TARGET_LOST_TIMEOUT = 0.3;
        public static final double MAX_VISION_JUMP = 0.25;
        public static final double MAX_ANGLE_JUMP = 0.1;//tune??
        public static final double TIMEOUT_COMMAND = 0.4;
        public static final double MIN_AMBIGUITY = 0.2;//tune
        public static final double TARGET_SWITCH_DELAY = 0.2;
        public static final int BUFFER_SIZE = 5;//amt readings before reset odometry

        public static final double BLEND_FACTOR = 0.1; //Photon and Odometry integration
        public static final double MAX_COMBINED_STD_DEV = 0.5;

        public static final Translation2d LEFT_DESIRED_TRANSLATION = new Translation2d(-2.0, 1.5);
        public static final Translation2d RIGHT_DESIRED_TRANSLATION = new Translation2d(2.0, -1.5);
